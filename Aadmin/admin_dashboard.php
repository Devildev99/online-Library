...
<body style="background-color: gray;">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<font style="color: white"><span><strong>Username(Email): <?php echo $_SESSION['email'];?></strong></span></font>
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="nav-item"><a class="nav-link" href="../exit.php">Logout</a></li>
			</ul>
		</div>
	</nav>
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
	<div class="container-fluid">
		<ul class="nav navbar-nav navbar-center">
			...
			<li class="nav-item">
				<a href="../pdf file using php/insert.php" class="nav-link">Insert Notice</a>
			</li>
			<li class="nav-item">
				<a href="../pdf file using php/dis.php" class="nav-link">Notice Updation</a>
			</li>
			<li class="nav-item">
				<a href="../image crud/in.php" class="nav-link">Study Metirial</a>
			</li>
			<li class="nav-item">
				<a href="../image crud/del.php" class="nav-link">Update of SM</a>
			</li>
		</ul>
	</div>
</nav>
